...
import 'package:purwakarta_app/ui/peta/rdtr.dart';
import 'package:purwakarta_app/ui/peta/rtrw.dart';
import 'constant/constant.dart';

class Maprdtr extends StatefulWidget {
  const Maprdtr({Key? key}) : super(key: key);

  @override
  MaprdtrState createState() => MaprdtrState();
}

class MaprdtrState extends State<Maprdtr> {
  int currentIndex = 0;
